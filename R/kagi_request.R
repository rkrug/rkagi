...
#'   `kagi_query_summarize`, `kagi_query_enrich_web`, `kagi_query_enrich_news`,
...
kagi_request <- function(
  ...
  if (
    ...
    stop(
      paste(
        "`query` must be of class `kagi_query_search`, `kagi_query_summarize`,",
        "`kagi_query_enrich_web`, `kagi_query_enrich_news`,",
        "`kagi_query_fastgpt` or `list` of such objects."
      )
    )
  }
